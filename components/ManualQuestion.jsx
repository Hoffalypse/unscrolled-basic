  ...
  return (
    <div className="flex flex-col items-center justify-center bg-slate-300 h-[50vh] rounded-xl">
      ...
      <input
        ...
        className="border border-gray-400 rounded-md px-2 py-1 ml-2 mb-4 w-[80%]"
      />

      <div className="mb-4">
        <label htmlFor="answer1">Answer 1(Correct):</label>
        <input
          type="text"
          id="answer1"
          value={answers[0]}
      ...
      <div className="mb-4">
        <label htmlFor="answer2">Answer 2(Wrong):</label>
        <input
          type="text"
          id="answer2"
          value={answers[1]}
      ...
      <div className="mb-4">
        <label htmlFor="answer3">Answer 3(Wrong):</label>
        <input
          type="text"
          id="answer3"
          value={answers[2]}
